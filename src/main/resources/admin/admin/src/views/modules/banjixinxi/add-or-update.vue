  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.banjihao" label="班级号" prop="banjihao">
              <el-input v-model="ruleForm.banjihao" 
                placeholder="班级号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.banjitupian" label="班级图片" prop="banjitupian">
          <file-upload
          tip="点击上传班级图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.banjitupian" label="班级图片" prop="banjitupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.banjitupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
